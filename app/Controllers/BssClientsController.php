...
class BssClientsController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->mm = $this->getBssClientsModel();

        // Assign default response messages
        $this->getRecordFoundMsg = "Clients Record Found Successfully";
        $this->getRecordNotFoundMsg = "Clients Record Not Found";
        $this->createRecordSuccessMsg = "Clients Record Created Successfully";
        $this->updateRecordSuccessMsg = "Clients Record Updated Successfully";
        $this->deleteRecordSuccessMsg = "Clients Record Deleted Successfully";
        $this->validationFailedMsg = "Clients Form Validation Failed";
        $this->updateRecordIdNotFoundMsg = "Clients Id Not Found";
    }

    /**
     * Get a BssClients record by primary key.
     *
    ...
    /**
     * Create a new BssClients record.
     *
     * @param array $data
     * @return array
     * @throws \Throwable
    ...
    /**
     * Update an existing BssClients record.
     *
     * @param array $data
    ...
    /**
     * Delete a BssClients record by primary key.
     *
     * @param string|int $primaryKey
     * @return array
     */
