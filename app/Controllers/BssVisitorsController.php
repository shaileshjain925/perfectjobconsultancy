...
class BssVisitorsController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->mm = $this->getBssVisitorsModel();

        // Assign default response messages
        $this->getRecordFoundMsg = "Visitors Record Found Successfully";
        $this->getRecordNotFoundMsg = "Visitors Record Not Found";
        $this->createRecordSuccessMsg = "Visitors Record Created Successfully";
        $this->updateRecordSuccessMsg = "Visitors Record Updated Successfully";
        $this->deleteRecordSuccessMsg = "Visitors Record Deleted Successfully";
        $this->validationFailedMsg = "Visitors Form Validation Failed";
        $this->updateRecordIdNotFoundMsg = "Visitors Id Not Found";
    }

    /**
     * Get a BssVisitors record by primary key.
     *
    ...
    /**
     * Create a new BssVisitors record.
     *
     * @param array $data
     * @return array
     * @throws \Throwable
    ...
    /**
     * Update an existing BssVisitors record.
     *
     * @param array $data
    ...
    /**
     * Delete a BssVisitors record by primary key.
     *
     * @param string|int $primaryKey
     * @return array
     */
