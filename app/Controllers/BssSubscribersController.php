...
class BssSubscribersController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->mm = $this->getBssSubscribersModel();

        // Assign default response messages
        $this->getRecordFoundMsg = "Subscribers Record Found Successfully";
        $this->getRecordNotFoundMsg = "Subscribers Record Not Found";
        $this->createRecordSuccessMsg = "Subscribers Record Created Successfully";
        $this->updateRecordSuccessMsg = "Subscribers Record Updated Successfully";
        $this->deleteRecordSuccessMsg = "Subscribers Record Deleted Successfully";
        $this->validationFailedMsg = "Subscribers Form Validation Failed";
        $this->updateRecordIdNotFoundMsg = "Subscribers Id Not Found";
    }

    /**
     * Get a BssSubscribers record by primary key.
     *
    ...
    /**
     * List all BssSubscribers records.
     *
     * @param array $filter
     * @return array
     */
    ...
    /**
     * Create a new BssSubscribers record.
     *
     * @param array $data
     * @return array
     * @throws \Throwable
    ...
    /**
     * Update an existing BssSubscribers record.
     *
     * @param array $data
    ...
    /**
     * Delete a BssSubscribers record by primary key.
     *
     * @param string|int $primaryKey
     * @return array
     */
