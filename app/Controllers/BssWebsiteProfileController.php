...
class BssWebsiteProfileController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->mm = $this->getBssWebsiteProfileModel();

        // Assign default response messages
        $this->getRecordFoundMsg = "Website Profile Record Found Successfully";
        $this->getRecordNotFoundMsg = "Website Profile Record Not Found";
        $this->createRecordSuccessMsg = "Website Profile Record Created Successfully";
        $this->updateRecordSuccessMsg = "Website Profile Record Updated Successfully";
        $this->deleteRecordSuccessMsg = "Website Profile Record Deleted Successfully";
        $this->validationFailedMsg = "Website Profile Form Validation Failed";
        $this->updateRecordIdNotFoundMsg = "Website Profile Id Not Found";
    }

    /**
     * Get a Website Profile record by primary key.
     *
    ...
    /**
     * List all BssWebsiteProfile records.
     *
     * @param array $filter
     * @return array
     */
    public function list(array|null $filter = []): array
    {
        try {
            ...
            return formatCommonResponse(ApiResponseStatusCode::OK, $this->getRecordFoundMsg, $result[0]);
        } catch (\Throwable $th) {
            return formatCommonResponse(ApiResponseStatusCode::BAD_REQUEST,  $th->getMessage());
        }
    }
    ...
    /**
     * Create a new BssWebsiteProfile record.
     *
     * @param array $data
     * @return array
     * @throws \Throwable
    ...
    /**
     * Update an existing BssWebsiteProfile record.
     *
     * @param array $data
    ...
    /**
     * Delete a BssWebsiteProfile record by primary key.
     *
     * @param string|int $primaryKey
     * @return array
     */
    ...
    public function CreateUpdate(&$data){
        $WebsiteProfileData = $this->mm->findAll();
        if(empty($WebsiteProfileData)){
            return $this->create($data);
        }else{
            return $this->update($data,$WebsiteProfileData[0]['id']);
        }
    }
}
