...
class BssFormSubmissionsController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->mm = $this->getBssFormSubmissionsModel();

        // Assign default response messages
        $this->getRecordFoundMsg = "Form Submissions Record Found Successfully";
        $this->getRecordNotFoundMsg = "Form Submissions Record Not Found";
        $this->createRecordSuccessMsg = "Form Submissions Record Created Successfully";
        $this->updateRecordSuccessMsg = "Form Submissions Record Updated Successfully";
        $this->deleteRecordSuccessMsg = "Form Submissions Record Deleted Successfully";
        $this->validationFailedMsg = "Form Submissions Form Validation Failed";
        $this->updateRecordIdNotFoundMsg = "Form Submissions Id Not Found";
    }

    /**
     * Get a BssFormSubmissions record by primary key.
     *
    ...
    /**
     * List all BssFormSubmissions records.
     *
     * @param array $filter
     * @return array
     */
    ...
    /**
     * Create a new BssFormSubmissions record.
     *
     * @param array $data
     * @return array
     * @throws \Throwable
    ...
    /**
     * Update an existing BssFormSubmissions record.
     *
     * @param array $data
    ...
    /**
     * Delete a BssFormSubmissions record by primary key.
     *
     * @param string|int $primaryKey
     * @return array
     */
