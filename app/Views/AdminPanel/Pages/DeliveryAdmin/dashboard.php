    ...
    <div class="card shadow mb-4 pb-4">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <a href="@Url.Action("Total_Positive","Home")" class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Shipped </div>
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <a href="@Url.Action("Total_Negative","Home")" class="card border-left-warning shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Deliverd</div>
