                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <div>
                                ...
                                <div class="d-flex align-items-start mt-4">
                                    <div class="avatar-sm me-3">
                                        <img src="<?=base_url($_assets_path.'assets/images/users/avatar-4.jpg')?>" alt="avatar-4" class="img-fluid rounded-circle">
                                    </div>
                                    <div class="flex-1">
                ...
                <ul class="inbox-wid list-unstyled">
                        ...
                        <a href="javascript: void(0);">
                            <div class="d-flex align-items-start">
                                <div class="me-3 align-self-center">
                                    <img src="<?=base_url($_assets_path.'assets/images/users/avatar-3.jpg')?>" alt="avatar-3" class="avatar-sm rounded-circle">
                                </div>
                    ...
                    <li class="inbox-list-item">
                        <a href="javascript: void(0);">
                            <div class="d-flex align-items-start">
                                <div class="me-3 align-self-center">
                                    <img src="<?=base_url($_assets_path.'assets/images/users/avatar-4.jpg')?>" alt="avatar-4" class="avatar-sm rounded-circle">
                                </div>
                                <div class="flex-1 overflow-hidden">
                    ...
                    <li class="inbox-list-item">
                        <a href="javascript: void(0);">
                            <div class="d-flex align-items-start">
                                <div class="me-3 align-self-center">
                                    <img src="<?=base_url($_assets_path.'assets/images/users/avatar-5.jpg')?>" alt="avatar-5" class="avatar-sm rounded-circle">
                                </div>
                                <div class="flex-1 overflow-hidden">
                    ...
                    <li class="inbox-list-item">
                        <a href="javascript: void(0);">
                            <div class="d-flex align-items-start">
                                <div class="me-3 align-self-center">
                                    <img src="<?=base_url($_assets_path.'assets/images/users/avatar-6.jpg')?>" alt="avatar-6" class="avatar-sm rounded-circle">
                                </div>
                                <div class="flex-1 overflow-hidden">
