                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-4">
                                    ...
                                    <p class="card-title-desc mb-0">Make buttons look inactive by adding the <code>disabled</code> boolean attribute to any <code> &lt;button&gt; </code> element. Disabled buttons have <code>pointer-events: none</code> applied to, preventing hover and active states from triggering.</p>     
                                </div>
                                <div class="button-items">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-grid gap-2">
                                    <button type="button"
                                        ...
                                        level button</button>
                                    <button type="button"
                                        class="btn btn-secondary btn-sm btn-block waves-effect waves-light">Block
                                        level button</button>
                                </div>
                            </div> <!--end card body-->
                        </div> <!--end card-->
